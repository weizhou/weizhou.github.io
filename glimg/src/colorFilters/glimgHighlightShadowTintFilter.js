...
export class GLImgHighlightShadowTintFilter extends GLImgFilter {
  constructor() {
    ...
    this.shadowTintColor = [1.0, 0.0, 0.0, 1.0];
    this.highlightTintColor = [0.0, 0.0, 1.0, 1.0];
  }
  ...
  bindShaderAttributes(gl, glProgram){  
    ...
    this.setUniformValue4fv(gl, glProgram, 'shadowTintColor', this.shadowTintColor);
    this.setUniformValue4fv(gl, glProgram, 'highlightTintColor', this.highlightTintColor);
  }
}